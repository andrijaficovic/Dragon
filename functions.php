...
add_action('acf/init', 'dragon_block_types');
function dragon_block_types()
{
	acf_register_block_type(array(
		'name'            => 'featured-content-block',
		'title'           => __('Featured Content Block'),
		'description'     => __('A custom Featured Content Block.'),
		'render_template' => 'template-parts/blocks/featured-content-block.php',
		'category'        => 'formatting',
		'icon'            => 'book-alt',
		'keywords'        => array('data', 'points', 'data-points'),
		'mode'            => 'auto',
		'enqueue_style'   => __DIR__ . '/style.css',
	));
}
...
{
	wp_enqueue_style('dragon-style', get_stylesheet_uri(), array(), _S_VERSION);
	wp_style_add_data('dragon-style', 'rtl', 'replace');

	wp_enqueue_style('custom-styles', get_template_directory_uri() . '/custom-styles.css', array(), '1.0.0'); // Replace '1.0.0' with your desired version number

	wp_enqueue_script('dragon-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true);
	wp_enqueue_script('jquery');
	wp_enqueue_script('custom-scripts', get_template_directory_uri() . '/js/custom.js', array(), '1.0', true);
